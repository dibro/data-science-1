...
predict_dataset = numsatz_norm[10806, features]
...
train_actuals <- numsatz$Umsatz[train_ind]
test_actuals <- numsatz$Umsatz[-train_ind]
...
cat(paste0("Vorhergesagter Umsatz:\t", format(predict_predictions[1], digits=2, nsmall =0)))

#cat(paste0("\nTatsächlicher Umsatz:\t", test_actuals[1]))

...
norm_list <- c("Umsatz", "Temperatur", Warengruppe_dummies, Wochentag_dummies) # Liste aller Variablen
norm_values_list <- get.norm_values(numsatz_dummy, norm_list)    # Berechnung der Mittelwerte und Std.-Abw. der Variablen
numsatz_norm <- norm_cols(numsatz_dummy, norm_values_list) # Standardisierung der Variablen

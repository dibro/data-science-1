...
# Selektion der Warengruppe
umsatzdaten <- umsatzdaten[umsatzdaten$Warengruppe==1,]
...
norm_list <- c("Umsatz", "Temperatur", Wochentag_dummies, Regen_dummies)
...
features = c('Temperatur', Wochentag_dummies, Regen_dummies)
